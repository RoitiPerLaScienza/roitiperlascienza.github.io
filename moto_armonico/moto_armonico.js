...
function preload(){
    ...
    accelerazione = false;
    peso = false;
    TestoSpiegazione=loadImage("data/SfondoArmonico.jpg");
    Simulazione1=loadImage("data/Armonico3.jpg");
    Simulazione2=loadImage("data/Pendolo.jpg");
    Pausa=loadImage("data/TastoPausa.png");
    Play=loadImage("data/TastoPlay.png");
    Play2=loadImage("data/TastoPlay2.png");
    Pausa2=loadImage("data/TastoPausa2.png");
    FormuleOndaArmonica=loadImage("data/FormuleMotoArmonico.PNG");
    FormulePendolo=loadImage("data/FormulePendolo.PNG");
    Comicfont=loadFont("data/ComicSansMSBoldItalic.vlw");
}
